...
@Component({
  selector: 'app-rapport-cr-selector',
  templateUrl: './rapport-cr-selector.component.html',
  styleUrls: ['./rapport-cr-selector.component.css']
})
export class RapportCrSelectorComponent implements OnInit {
  ...
  openCr(): void {
    ...
    this.router.navigate(['/societe/rapport-cr', this.selectedRapportId]);
  }
}
